...
function handleToggle() {
    ...
    if (style != null) {
        style.remove();
        playSound("https://github.com/Siriusmart/Equibored/raw/main/sounds/demonstration/wp5rpz.wav");
    }
    else {
                ...
                <ModalRoot {...props}>
                    ...
                    <Button
                        onClick={() => {
                            closeModal(key);
                            injectCSS();
                            playSound("https://github.com/Siriusmart/Equibored/raw/main/sounds/demonstration/ckz46t.wav");
                        }}
                    >Okay!</Button>
                </ModalRoot>
            ));
